                ...
                <ScrollView vertical showsVerticalScrollIndicator={false}>
                    ...
                    <View style={styles.wrapperLabel}>
                        <Text style={styles.label}>
                            Ayo{' '}
                            <Text style={styles.textBold}>Wayahe Futsal</Text>
                        </Text>
                    </View>
                    <View style={styles.layanan}>
                        <Layanan
                            ...
                            active={
                                this.state.layanan === 'paket' ? true : false
                            }
                        />
                        <Layanan
                            ...
                            active={
                                this.state.layanan === 'booking' ? true : false
                            }
                        />
                        <Layanan
                            title="Join Team"
                            ...
                            active={
                                this.state.layanan === 'join' ? true : false
                            }
                        />
                    </View>
                        ...
                        >
                            <View style={styles.score}>
                                <UpdateScore
                                    ...
                                    score1="5"
                                    score2="2"
                                    date="Rabu, 22 September 2021 19.00 WIB"
                                />
                                <UpdateScore
                                    klub1="VE FC"
                                    klub2="Arsyil FC"
                                    score1="7"
                                    score2="4"
                                    date="Kamis, 23 September 2021 19.00 WIB"
                                />
                                <UpdateScore
                                    klub1="Bogor FC"
                                    klub2="Awang Long FA"
                                    score1="1"
                                    score2="4"
                                    date="Jumat, 24 September 2021 19.00 WIB"
                                />
                            </View>
                        </ScrollView>
                    </View>
